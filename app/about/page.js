    ...
    return(
        <>
            <div className="min-h-full max-w-[1440px] mx-auto p-4">
                ...
                <p className={paragraphStyle}>Greetings! Welcome to my CS50 E-Commerce Project—an exhilarating journey of coding, creativity, and continuous learning. This project, a culmination of my experiences in the esteemed CS50 course, serves as a testament to my growth in web development. Join me in exploring the intricacies of this site, which I&aposve meticulously crafted using Next.js version 14 with App Router, Auth.js, Tailwind CSS, and MongoDB.</p>

                <h2 className={h2Style}>About the Project</h2>
                <p className={paragraphStyle}>This e-commerce platform is not just a virtual storefront; it&apoxs a manifestation of my dedication to mastering the art of web development. With a focus on seamless user experiences and robust functionality, every line of code represents a step forward in my understanding of modern technologies that power e-commerce websites.</p>
                ...
                <p className={paragraphStyle}>It&aposs crucial to clarify that this website is a personal educational project developed within the framework of the CS50 course. As such, the e-commerce features showcased here are simulated for learning purposes only. <strong className="underline decoration-solid">Please note that no real transactions can be conducted on this site.</strong></p>
                ...
                <p className={paragraphStyle}>Thank you for taking the time to explore my CS50 E-Commerce Project. As you navigate through the site, please keep in mind that it&aposs a result of my dedication to learning and applying cutting-edge web development technologies. Enjoy your virtual shopping experience!</p>
